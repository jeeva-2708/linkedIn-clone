...
const Home = () => {
  ...
  // ✅ Real-time Post Feed with Safe Fallback
  useEffect(() => {
      ...
      <div className="max-w-2xl mx-auto p-4">
        ...
        <form onSubmit={handlePost} className="mb-6">
          <textarea
            ...
            className="w-full border p-2 rounded mb-2 focus:outline-none focus:ring focus:ring-blue-200"
          />
          <button
            type="submit"
          ...
          {posts.length === 0 ? (
            ...
            posts.map((p) => (
              <div key={p.id} className="border p-4 rounded shadow bg-white">
                ...
                <p className="mt-1 text-gray-800">{p.content}</p>
